...
export const VaccineStatus: Story = {
    ...
    docs: {
      description: {
        story:
          ...
          'not have to distinguish green from amber to know what is overdue — the icon and the ' +
  ...
  render: () => (
    <div className="flex flex-wrap items-center gap-3">
      <Badge className="bg-emerald-50 dark:bg-emerald-950/40 text-emerald-700 dark:text-emerald-300">
        <CheckIcon />
        Aplicada
      </Badge>
      ...
      <Badge className="bg-rose-50 dark:bg-rose-950/40 text-rose-700 dark:text-rose-300">
        <AlertCircleIcon />
        Atrasada
      </Badge>
