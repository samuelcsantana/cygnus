    ...
    <div className={cn('flex flex-wrap gap-2', className)} role="group" aria-label={t('common.babyFilter.groupLabel')}>
      <button
        ...
        className={cn(
          ...
          value === null ? 'bg-primary text-white' : 'bg-card text-ink-muted shadow-sm hover:bg-muted',
        )}
      >
        ...
        return (
          <button
            ...
            className={cn(
              ...
              isActive ? 'bg-primary text-white' : 'bg-card text-ink-muted shadow-sm hover:bg-muted',
            )}
          >
            <span
              className={cn(
